...
public class ExtendedBottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    public ExtendedBottomSheetBehavior(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    public void setNoHalfStateExpandedOffset(int offset) {
        setExpandedOffset(offset);
        setFitToContents(false);
        this.halfExpandedEnabled = false;
    }
                ...
                public void onViewReleased(@NonNull View releasedChild, float xvel, float yvel) {
                    ...
                    if (yvel < 0) { // Moving up
                        ...
                        if ((Math.abs(xvel) < Math.abs(yvel) && yvel > SIGNIFICANT_VEL_THRESHOLD)
                            ...
                            top = fitToContentsOffset;
                            targetState = STATE_EXPANDED;
                        } else if (!halfExpandedEnabled && Math.abs(releasedChild.getTop() - expandedOffset)
    ...
    protected static class SavedState extends AbsSavedState {
        ...
        public SavedState(Parcelable superState, @NonNull ExtendedBottomSheetBehavior<?> behavior) {
            super(superState);
        ...
        /**
         * This constructor does not respect flags: {@link ExtendedBottomSheetBehavior#SAVE_PEEK_HEIGHT}, {@link
         * ExtendedBottomSheetBehavior#SAVE_FIT_TO_CONTENTS}, {@link ExtendedBottomSheetBehavior#SAVE_HIDEABLE}, {@link
         * ExtendedBottomSheetBehavior#SAVE_SKIP_COLLAPSED}. It is as if {@link ExtendedBottomSheetBehavior#SAVE_NONE}
         * were set.
         *
         * @deprecated Use {@link SavedState(Parcelable, ExtendedBottomSheetBehavior )} instead.
         */
        @Deprecated
    ...
    public static <V extends View> ExtendedBottomSheetBehavior<V> from(@NonNull V view) {
